param(
  [switch]$WhatIf,
  [string[]]$Skill = @('coding-workflow', 'generating-reqable-docs', 'idea-shaping', 'team-memory', 'using-tool', 'writing-skills')
)
...
$ApprovedSkills = @('coding-workflow', 'generating-reqable-docs', 'idea-shaping', 'team-memory', 'using-tool', 'writing-skills')
