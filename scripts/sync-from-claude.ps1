param(
  [switch]$WhatIf,
  [string[]]$Skill = @('coding-workflow', 'generating-reqable-docs', 'idea-shaping', 'session-handoff-load', 'session-handoff-save', 'team-memory', 'using-tool', 'writing-skills')
)
...
$ApprovedSkills = @('coding-workflow', 'generating-reqable-docs', 'idea-shaping', 'session-handoff-load', 'session-handoff-save', 'team-memory', 'using-tool', 'writing-skills')
